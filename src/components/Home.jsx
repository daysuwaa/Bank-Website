  ...
  <div style={{ border: '1px solid #262626', borderRadius: '12px', width: '358px', height: '370px', margin: 'auto', position: 'relative' }}>
    ...
    <div style={{ display: 'grid', alignItems: 'center', gridTemplateColumns: '1fr 1fr', gridTemplateRows: '1fr 1fr', padding: '1rem', justifyContent: 'center', position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', gap: '14px', paddingTop: '2.5rem' }}>
      ...
      <div className='w-[154px] h-[160px]'>
        <div style={{ display: 'flex', padding: '20px 14px', flexDirection: 'column', alignItems: 'center', gap: '14px', background: 'var(--grey-10, #1A1A1A)', borderRadius: '12px', flex: '1 0 0', border: '1px solid #262626' }}>
          <div style={{ borderRadius: '12px', border: '1px solid var(--grey-15, #262626)', background: 'var(--grey-19, #1A1A1A)' }}>
            <img src={Education} alt='frame' style={{ borderRadius: '50px', border: '1px solid #CAFF33', background: 'linear-gradient(180deg, rgba(202, 255, 51, 0.10) -66.22%, rgba(202, 255, 51, 0.00) 85.46%)', padding: '12px' }} />
          </div>
 ...
 <div style={{ display: 'grid', alignItems: 'center', gridTemplateColumns: '1fr 1fr', gridTemplateRows: '1fr 1fr', padding: '1rem', justifyContent: 'center', position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', gap:'14px', paddingTop:'2.5rem' }}>
   ...
   <div>
    <div className='grid grid-cols-2 '>
      {/* first cols */}
      <div>
      <div style={{ border: '1px solid #262626', borderRadius: '12px', height:'414px',  position: 'relative',  margin:'0 5rem'}}>
     <img src={Abstract} alt='abs' style={{ width: '118px', height: '112px', transform: 'rotate(-90deg)', position: 'absolute' }} />
     <div>
      <div className='grid grid-cols-2 grid-rows-2 px-5 mt-7'>

        <div style={{display:'flex', padding:'24px', flexDirection:'column', gap:'14px', flex:'1 0 0' , alignContent:'center', justifyContent:'center', textAlign:'center', height:'174px' }}>
        <div style={{ borderRadius: '12px', border: '1px solid var(--grey-15, #262626)', background: 'var(--grey-19, 1A1A1A)' , height:'174px', paddingTop:'15px'}}>
            <img src={Frame} alt='frame' style={{ borderRadius: '50px', border: '1px solid #CAFF33', background: 'linear-gradient(180deg, rgba(202, 255, 51, 0.10) -66.22%, rgba(202, 255, 51, 0.00) 85.46%)', padding: '12px', }} className="mx-auto" />
            <p style={{ color: 'var(--absolute-white, #FFF)', fontSize: '14px', fontStyle: 'normal', fontWeight: '500' }}>Managing Personal Finances</p>
          </div>  
        </div>
        {/* 1 */}
        <div style={{display:'flex', padding:'24px', flexDirection:'column', gap:'14px', flex:'1 0 0' , alignContent:'center', justifyContent:'center', textAlign:'center', height:'174px' }}>
        <div style={{ borderRadius: '12px', border: '1px solid var(--grey-15, #262626)', background: 'var(--grey-19, 1A1A1A)' , height:'174px', paddingTop:'15px'}}>
            <img src={House} alt='frame' style={{ borderRadius: '50px', border: '1px solid #CAFF33', background: 'linear-gradient(180deg, rgba(202, 255, 51, 0.10) -66.22%, rgba(202, 255, 51, 0.00) 85.46%)', padding: '12px', height:'48px', width:'50px' }} className="mx-auto" />
            <p style={{ color: 'var(--absolute-white, #FFF)', fontSize: '14px', fontStyle: 'normal', fontWeight: '500', paddingTop:'2px' }}>Saving for the Future</p>
          </div>  
        </div>
        {/* 2 */}
        <div style={{display:'flex', padding:'24px', flexDirection:'column', gap:'14px', flex:'1 0 0' , alignContent:'center', justifyContent:'center', textAlign:'center', height:'174px' }}>
        <div style={{ borderRadius: '12px', border: '1px solid var(--grey-15, #262626)', background: 'var(--grey-19, 1A1A1A)' , height:'174px', paddingTop:'15px'}}>
            <img src={House} alt='frame' style={{ borderRadius: '50px', border: '1px solid #CAFF33', background: 'linear-gradient(180deg, rgba(202, 255, 51, 0.10) -66.22%, rgba(202, 255, 51, 0.00) 85.46%)', padding: '12px', }} className="mx-auto" />
        ...
        <div style={{display:'flex', padding:'24px', flexDirection:'column', gap:'14px', flex:'1 0 0' , alignContent:'center', justifyContent:'center', textAlign:'center', height:'174px' }}>
        <div style={{ borderRadius: '12px', border: '1px solid var(--grey-15, #262626)', background: 'var(--grey-19, 1A1A1A)' , height:'174px', paddingTop:'15px'}}>
            <img src={Education} alt='frame' style={{ borderRadius: '50px', border: '1px solid #CAFF33', background: 'linear-gradient(180deg, rgba(202, 255, 51, 0.10) -66.22%, rgba(202, 255, 51, 0.00) 85.46%)', padding: '12px', }} className="mx-auto" />
            <p style={{ color: 'var(--absolute-white, #FFF)', fontSize: '14px', fontStyle: 'normal', fontWeight: '500' }}>Education Funding</p>
          </div>  
        </div>
        {/* 4 */}
...
{/* start of 2 */}
<div>
<p style={{ color: 'var(--absolute-white, #FFF)', fontSize: '26px', fontStyle: 'normal', fontWeight: '500', fontFamily: 'lexend' }}>For Individuals</p>
<p style={{ color: 'var(--grey-70, #B3B3B3)', fontFamily: 'lexend', fontSize: '16px', paddingBottom: '2rem' }} className='pt-4'>For individuals, our mortgage services pave the way to homeownership, and our flexible personal loans provide vital support during various life milestones. We also prioritize retirement planning, ensuring a financially secure future for our customers</p>
      <div className='grid grid-cols-3'>
        <div>
        <h1 style={{ color: 'var(--green-60, #CAFF33)',  fontSize: '40px' }} className='font-bold'>78%</h1>
        <p style={{ color: 'var(--grey-70, #B3B3B3)',  fontSize: '15px', fontFamily: 'lexend', lineHeight:'22.5px' }}>Secure Retirement <br></br> Planning</p>
        </div>
        {/* 1 */}
        <div>
        <h1 style={{ color: 'var(--green-60, #CAFF33)',  fontSize: '40px' }} className='font-bold'>63%</h1>
        <p style={{ color: 'var(--grey-70, #B3B3B3)',  fontSize: '15px', fontFamily: 'lexend', lineHeight:'22.5px' }}>Manageable Debt Consideration</p>

        </div>
        {/* 2 */}
        <div>
        <h1 style={{ color: 'var(--green-60, #CAFF33)',  fontSize: '40px' }} className='font-bold'>91%</h1>
        <p style={{ color: 'var(--grey-70, #B3B3B3)',  fontSize: '15px', fontFamily: 'lexend', lineHeight:'22.5px' }}>Reducing financial<br></br> burden</p>
        </div>
        {/* 3 */}
      </div>
      <div style={{ display: 'flex', padding: '20px 0px', justifyContent: 'start', paddingTop:'2rem' }}>
      <button style={{ borderRadius: '82px', border: '1px solid var(--grey-15, #262626)', background: 'var(--grey-11, #1C1C1C)', width: '118px', height: '48px' }}>
        <p className='text-white font-lexend'>Learn More</p>
      </button>
    </div>
...
<div>
  <div className='grid grid-cols-2 pl-[3rem]'>
    <div>
    <p style={{ color: 'var(--absolute-white, #FFF)', fontSize: '26px', fontStyle: 'normal', fontWeight: '500', fontFamily: 'lexend' }}>For Business</p>
    <p style={{ color: 'var(--grey-70, #B3B3B3)', fontFamily: 'lexend', fontSize: '16px', paddingBottom: '2rem' }} className='pt-4'> For businesses, we empower growth with working capital solutions that optimize cash flow, and our tailored financing options fuel business expansion. Whatever your financial aspirations, YourBank is committed to providing the right tools and support to achieve them</p>
    
    <div className='grid grid-cols-3'>
        <div>
        <h1 style={{ color: 'var(--green-60, #CAFF33)',  fontSize: '40px' }} className='font-bold'>65%</h1>
        <p style={{ color: 'var(--grey-70, #B3B3B3)',  fontSize: '15px', fontFamily: 'lexend', lineHeight:'22.5px' }}>Cash Flow <br></br>Management</p>
        </div>
        {/* 1 */}
        <div>
        <h1 style={{ color: 'var(--green-60, #CAFF33)',  fontSize: '40px' }} className='font-bold'>70%</h1>
        <p style={{ color: 'var(--grey-70, #B3B3B3)',  fontSize: '15px', fontFamily: 'lexend', lineHeight:'22.5px' }}>Drive Business <br></br>Expiration</p>

        </div>
        {/* 2 */}
        <div>
        <h1 style={{ color: 'var(--green-60, #CAFF33)',  fontSize: '40px' }} className='font-bold'>45%</h1>
        <p style={{ color: 'var(--grey-70, #B3B3B3)',  fontSize: '15px', fontFamily: 'lexend', lineHeight:'22.5px' }}>Streamline payroll<br></br> processing</p>
        </div>
        {/* 3 */}
      </div>
      <div style={{ display: 'flex', padding: '20px 0px', justifyContent: 'start', paddingTop:'2rem' }}>
    ...
    <div>
      <div className='grid grid-cols-2 grid-rows-2 px-5 mt-7'>
        ...
        <div style={{display:'flex', padding:'24px', flexDirection:'column', gap:'14px', flex:'1 0 0' , alignContent:'center', justifyContent:'center', textAlign:'center', height:'174px' }}>
        <div style={{ borderRadius: '12px', border: '1px solid var(--grey-15, #262626)', background: 'var(--grey-19, 1A1A1A)' , height:'174px', paddingTop:'15px'}}>
            <img src={Start} alt='frame' style={{ borderRadius: '50px', border: '1px solid #CAFF33', background: 'linear-gradient(180deg, rgba(202, 255, 51, 0.10) -66.22%, rgba(202, 255, 51, 0.00) 85.46%)', padding: '12px', }} className="mx-auto" />
            <p style={{ color: 'var(--absolute-white, #FFF)', fontSize: '14px', fontStyle: 'normal', fontWeight: '500', textAlign:'center' }}>Startups and <br></br> Entrepreneurs</p>
          </div>  
        </div>
        {/* 1 */}
        <div style={{display:'flex', padding:'24px', flexDirection:'column', gap:'14px', flex:'1 0 0' , alignContent:'center', justifyContent:'center', textAlign:'center', height:'174px' }}>
        <div style={{ borderRadius: '12px', border: '1px solid var(--grey-15, #262626)', background: 'var(--grey-19, 1A1A1A)' , height:'174px', paddingTop:'15px'}}>
            <img src={Flow} alt='frame' style={{ borderRadius: '50px', border: '1px solid #CAFF33', background: 'linear-gradient(180deg, rgba(202, 255, 51, 0.10) -66.22%, rgba(202, 255, 51, 0.00) 85.46%)', padding: '12px', height:'48px', width:'50px' }} className="mx-auto" />
            <p style={{ color: 'var(--absolute-white, #FFF)', fontSize: '14px', fontStyle: 'normal', fontWeight: '500', paddingTop:'2px' }}>Cash Flow Management</p>
          </div>  
        </div>
        {/* 2 */}
        <div style={{display:'flex', padding:'24px', flexDirection:'column', gap:'14px', flex:'1 0 0' , alignContent:'center', justifyContent:'center', textAlign:'center', height:'174px' }}>
        <div style={{ borderRadius: '12px', border: '1px solid var(--grey-15, #262626)', background: 'var(--grey-19, 1A1A1A)' , height:'174px', paddingTop:'15px'}}>
            <img src={Business} alt='frame' style={{ borderRadius: '50px', border: '1px solid #CAFF33', background: 'linear-gradient(180deg, rgba(202, 255, 51, 0.10) -66.22%, rgba(202, 255, 51, 0.00) 85.46%)', padding: '12px', }} className="mx-auto" />
            <p style={{ color: 'var(--absolute-white, #FFF)', fontSize: '14px', fontStyle: 'normal', fontWeight: '500' }}>Business Expansion</p>
          </div>  
        </div>
        {/* 3 */}
        <div style={{display:'flex', padding:'24px', flexDirection:'column', gap:'14px', flex:'1 0 0' , alignContent:'center', justifyContent:'center', textAlign:'center', height:'174px' }}>
        <div style={{ borderRadius: '12px', border: '1px solid var(--grey-15, #262626)', background: 'var(--grey-19, 1A1A1A)' , height:'174px', paddingTop:'15px'}}>
            <img src={Payment} alt='frame' style={{ borderRadius: '50px', border: '1px solid #CAFF33', background: 'linear-gradient(180deg, rgba(202, 255, 51, 0.10) -66.22%, rgba(202, 255, 51, 0.00) 85.46%)', padding: '12px', }} className="mx-auto" />
            <p style={{ color: 'var(--absolute-white, #FFF)', fontSize: '14px', fontStyle: 'normal', fontWeight: '500' }}>Payment Solutions</p>
          </div>  
        </div>
        {/* 4 */}
      </div> 
...
{/* 
   ...
   <div className='pt-5' style={{}}>
        <p style={{ color: 'var(--green-60, #CAFF33)', fontSize: '28px', fontStyle: 'normal', fontWeight: '500', lineHeight: '57px',padding: '30px' }} className='font-extrabold'>
             Frequently <span style={{ color: 'var(--absolute-white, #FFF)'}}>Asked Questions</span>
              </p>
              <p style={{color:'var(--grey-70, #B3B3B3)', fontFamily:'lexend', fontSize:'14px',paddingLeft: '30px', letterSpacing:'-0.084px', lineHeight:'21px', paddingTop:'15px'}}> Still you have any questions? Contact our Team via support@yourbank.com</p>

        </div>

        <div style={{display: 'flex', padding: '30px', flexDirection: 'column', alignItems: 'flex-start', gap: '20px',  }}>
          <div className='grid lg:grid-cols-2 lg:grid-rows-2 text-start'>
            <div style={{borderRadius:'10px', border:'1px solid var(--grey-15, #262626)', background: 'var(--grey-11, #1C1C1C)' , padding:'30px' }}>
  ...
  <div className='pt-5'>
    ...
    {/* testimonials */}
      ...
      <div className='py-[5rem]'>
        ...
        <div>
          <p style={{ color: 'var(--grey-70, #B3B3B3)', fontFamily: 'Lexend', fontStyle: 'normal', fontWeight: '300', fontSize: '14px' }} className=' text-center lg:hidden px-2'>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }} className='hidden lg:block'>
          <h1 style={{ color: ' #FFF', fontFamily: 'Lexend', fontStyle: 'normal', fontWeight: '500', lineHeight: '57px,', fontSize: '38px' }} className='hidden lg:block px-[4rem]'>
            Our <span style={{ color: 'var(--green-60, #CAFF33)', fontFamily: 'Lexend', fontStyle: 'normal', fontWeight: '500', lineHeight: '58px' }}> Testimonials </span>
          </h1>
          <div className='hidden lg:block'>
            <div className=' flex  '>
              <p style={{ color: 'var(--grey-70, #B3B3B3)', fontFamily: 'Lexend', fontStyle: 'normal', fontWeight: '300', fontSize: '14px' }} className=' px-[4rem] '>
              Discover how YourBank has transformed lives with innovative digital solutions and personalized customer service. See why our clients trust us for a secure and prosperous financial journey
              </p>
              <div style={{ display: 'flex', padding: '12px', alignItems: 'flex-start', borderRadius: '82px', border: '1px solid var(--grey-15, #262626)' }} className="justify-center items-center  ">
                <button style={{ borderRadius: '140px', padding: '10px 18px', background: '#CAFF33', justifyContent: 'center', alignItems: 'center', gap: '10px' }} className=' w-[136px] h-[41px]  '>
