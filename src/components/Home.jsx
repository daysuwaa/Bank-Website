...
<div className='px-[4rem]'>
  ...
  <p style={{ color: 'var(--grey-70, #B3B3B3)', fontFamily: 'lexend', fontSize: '16px', letterSpacing: '-0.084px', lineHeight: '21px', paddingTop: '15px' }}> Still have any questions? Contact our Team via support@yourbank.com</p>
  ...
  <div style={{ textAlign: 'center' }} className='block lg:hidden md:block'>
    <div style={{ border: '1px solid #262626', borderRadius: '12px', width:'358px', height:'370px', margin:'auto', position: 'relative'}}>
      ...
      {/* start of large screen */}
      <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'flex-start' }} className='hidden lg:block mx-[2.6rem]'>
  <div>
